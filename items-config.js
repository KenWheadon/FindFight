...
const ITEMS_CONFIG = {
  ...
  locations: {
    ...
    forestClearing: {
      ...
      revealDuration: 60,
      itemPositions: [
        { itemId: 1, x: 20.3, y: 81.7, scale: 2.55, initiallyVisible: true },
        { itemId: 2, x: 2.1, y: 6.3, scale: 1.2, initiallyVisible: true },
        { itemId: 3, x: 34.4, y: 73.9, scale: 1.1, initiallyVisible: true },
        { itemId: 4, x: 70.0, y: 85.0, scale: 0.7, initiallyVisible: true },
        { itemId: 5, x: 47.1, y: 67.0, scale: 1.0, initiallyVisible: true },
        { itemId: 6, x: 82.9, y: 79.7, scale: 1.21, initiallyVisible: true },
        { itemId: 7, x: 19.1, y: 14.1, scale: 1.25, initiallyVisible: true },
        { itemId: 8, x: 78.3, y: 84.6, scale: 0.85, initiallyVisible: true },
        ...
        { itemId: 12, x: 73.0, y: 14.3, scale: 1.17, initiallyVisible: false },
        { itemId: 13, x: 17.0, y: 71.3, scale: 0.94, initiallyVisible: false },
        { itemId: 14, x: 5.4, y: 95.0, scale: 1.06, initiallyVisible: false },
        { itemId: 15, x: 83.0, y: 52.8, scale: 1.0, initiallyVisible: false },
        { itemId: 16, x: 16.0, y: 57.4, scale: 1.58, initiallyVisible: false },
        { itemId: 17, x: 60.0, y: 81.6, scale: 2.64, initiallyVisible: false },
        { itemId: 18, x: 6.1, y: 84.0, scale: 2.07, initiallyVisible: false },
        { itemId: 19, x: 45.7, y: 85.6, scale: 1.35, initiallyVisible: false },
        { itemId: 20, x: 24.3, y: 65.1, scale: 1.0, initiallyVisible: false },
        { itemId: 21, x: 55.0, y: 35.4, scale: 1.13, initiallyVisible: false },
      ],
    },
    darkCatacombs: {
      name: "Dark Catacombs",
