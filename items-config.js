  ...
  locations: {
    detectiveOffice: {
      ...
      itemPositions: [
        ...
        { itemId: 6, x: 90.8, y: 82.9, scale: 1, initiallyVisible: true },
    ...
    forestClearing: {
      ...
      revealDuration: 30,
      itemPositions: [
        { itemId: 1, x: 21.0, y: 83.1, scale: 3.42, initiallyVisible: false },
        { itemId: 2, x: 2.3, y: 7.8, scale: 1.2, initiallyVisible: true },
        { itemId: 3, x: 34.4, y: 73.9, scale: 1.1, initiallyVisible: false },
        { itemId: 4, x: 84.6, y: 94.3, scale: 1.45, initiallyVisible: true },
        { itemId: 5, x: 50.6, y: 65.2, scale: 1.0, initiallyVisible: false },
        { itemId: 6, x: 93.4, y: 77.2, scale: 1.21, initiallyVisible: true },
        { itemId: 7, x: 21.3, y: 15.6, scale: 1.25, initiallyVisible: false },
        { itemId: 8, x: 79.8, y: 82.6, scale: 0.85, initiallyVisible: true },
        { itemId: 9, x: 61.1, y: 60.9, scale: 1.0, initiallyVisible: false },
        { itemId: 10, x: 28.6, y: 80.0, scale: 0.95, initiallyVisible: true },
        { itemId: 11, x: 50.6, y: 73.2, scale: 0.9, initiallyVisible: true },
        ...
        { itemId: 15, x: 93.8, y: 52.0, scale: 1.0, initiallyVisible: true },
        { itemId: 16, x: 18.4, y: 56.5, scale: 2.15, initiallyVisible: false },
        { itemId: 17, x: 63.4, y: 78.5, scale: 3.95, initiallyVisible: true },
        { itemId: 18, x: 8.2, y: 83.3, scale: 2.52, initiallyVisible: false },
        { itemId: 19, x: 45.7, y: 85.6, scale: 1.35, initiallyVisible: true },
        { itemId: 20, x: 27.3, y: 62.5, scale: 1.0, initiallyVisible: false },
        { itemId: 21, x: 55.6, y: 10.2, scale: 1.13, initiallyVisible: true },
      ],
    },
    darkCatacombs: {
      name: "Dark Catacombs",
      ...
      revealDuration: 25,
      itemPositions: [
        { itemId: 1, x: 2.2, y: 91.3, scale: 5.91, initiallyVisible: false },
        { itemId: 2, x: 27.7, y: 30.2, scale: 1.2, initiallyVisible: false },
        { itemId: 3, x: 60.9, y: 25.8, scale: 1.5, initiallyVisible: false },
        { itemId: 4, x: 16.2, y: 81.0, scale: 1.45, initiallyVisible: false },
        { itemId: 5, x: 90.7, y: 87.5, scale: 3.5, initiallyVisible: false },
        { itemId: 6, x: 4.6, y: 56.5, scale: 0.98, initiallyVisible: false },
        { itemId: 7, x: 79.4, y: 41.9, scale: 1.25, initiallyVisible: false },
        { itemId: 8, x: 74.5, y: 76.0, scale: 0.85, initiallyVisible: false },
        { itemId: 9, x: 7.9, y: 43.1, scale: 1.0, initiallyVisible: false },
        { itemId: 10, x: 70.1, y: 70.2, scale: 0.8, initiallyVisible: false },
        { itemId: 11, x: 53.7, y: 70.9, scale: 0.9, initiallyVisible: true },
        { itemId: 12, x: 83.3, y: 14.9, scale: 1.17, initiallyVisible: true },
        { itemId: 13, x: 20.4, y: 70.3, scale: 0.94, initiallyVisible: true },
        ...
        { itemId: 20, x: 33.4, y: 63.0, scale: 0.78, initiallyVisible: true },
        { itemId: 21, x: 33.4, y: 45.8, scale: 1.42, initiallyVisible: true },
      ],
    },
  },
